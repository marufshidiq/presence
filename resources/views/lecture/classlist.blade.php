                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                        
                                            ...
                                            <td>
                                                ...
                                                <button onclick="location.href='{{ route('lecture.class.reschedule.form', ['id'=>$data['id']]) }}'" @if($data['day'] < date("w")) disabled @endif class="btn btn-warning waves-effect">Reschedule</button>                                                
                                            </td>                                            
                                        </tr>
                                        @endforeach
                                    </tbody>

            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                
                    <div class="card">
                        ...
                        <div class="body">                                                        
                            <div class="row clearfix">
                                <form action="{{route('class.add')}}" id="class-add" method="POST">
                                    {{ csrf_field() }}
                                    <div class="col-sm-12">
                                        <h4 style="font-weight:bold; font-size:13px;" class="card-inside-title">Class Name</h4>
                                        <input type="text" class="form-control inp" name="name" id="name" required>
                                    </div> 
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control show-tick inp" name="room" id="room">
                                            ...
                                            <option @if($loop->first)selected @endif value="{{$data['id']}}">{{$data['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>                                                                      
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6" style="margin-bottom:20px;">
                                        ...
                                        <input type="text" class="timepicker form-control inp" name="start" id="start" value="14:00:00" required>                                                                                        
                                    </div>
                                    <div class="col-sm-6" style="margin-bottom:20px;">
                                        <h4 style="font-weight:bold; font-size:13px;" class="card-inside-title">Class End</h4>
                                        <input type="text" class="timepicker form-control inp" name="end" id="end" value="14:00:00" required>                                                                                        
                                    </div>                                    
                                    <div class="col-sm-12">                                        
                                        ...
                                        <button type="submit" style="margin-bottom: 12px; display:none;" id="btn-submit" class="btn btn-success btn-lg m-l-15 waves-effect sub">ADD</button>
